...
export default function Login() {
    ...
    const handleAuth = async (e: FormEvent) => {
        ...
        // Anti-Double-Click robusto: previne a corrida milissegunda onde 'loading' ainda não ativou na tela
        ...
        try {
            if (mode === 'login') {
                ...
                // para evitar cliques repetidos que desperdiçam os 2 emails/hora do Free Tier
                setCooldown(60);
                ...
                // Cooldown de 60s para não mandar múltiplos emails e estourar o rate limit
                setCooldown(60);
                if (cooldownTimer.current) clearInterval(cooldownTimer.current);
                cooldownTimer.current = setInterval(() => {
                    setCooldown(prev => {
    ...
    const titles: Record<Mode, string> = {
        ...
        magic_link: 'Primeiro acesso ou entrar sem senha',
        recovery: 'Recuperar senha',
    };

    const subtitles: Record<Mode, string> = {
        login: 'Entre na sua conta para acessar a plataforma.',
        magic_link: 'Comprou agora? Enviaremos um link de acesso direto para o e-mail usado na compra.',
                        ...
                        <form onSubmit={handleAuth} className="space-y-4">
                            ...
                            >
                                ...
                                {loading
                                    ...
                                    : cooldown > 0
                                        ? <><span className="relative z-10">Aguarde {cooldown}s para reenviar</span></>
